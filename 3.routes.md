...
Route::get('/posts/{post}', [PostController::class, 'show']); // Implicit Binding
...
```php
Route::get('/confirm-email-address', ConfirmEmailAddressController::class);
```
...
```
[Next](https://github.com/jcergolj/my-laravel-adventure/blob/master/4.controllers.md)
